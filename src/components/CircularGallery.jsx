...
class Title {
  constructor({ gl, plane, renderer, text, textColor = '#545050', font = '20px SansHeadline' }) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
class App {
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    const defaultItems = [
      { image: MyPhoto, text: 'MAHATI' },
      { image: Mumbai, text: 'MUMBAI, IN' },
      { image: Laptop, text: 'CODE' },
      { image: Food, text: 'EAT' },
      { image: Travel, text: 'TRAVEL' },
      { image: Dance, text: 'DANCE' },
      { image: Netflix, text: 'NETFLIX N CHILL' },
